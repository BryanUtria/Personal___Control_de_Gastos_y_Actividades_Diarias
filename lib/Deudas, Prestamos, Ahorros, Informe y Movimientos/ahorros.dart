...
class ahorros extends StatefulWidget {
  ...
  const ahorros(this.datos, {Key? key}) : super(key: key);

  @override
  ahorros_App createState() => ahorros_App();
}

class ahorros_App extends State<ahorros> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        backgroundColor: Color(0xFFE5DD95),
        body: Container(
            child: Center(
                child: Column(
                  children: [

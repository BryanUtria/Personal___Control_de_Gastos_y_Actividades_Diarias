...
class Ver_Cliente_Deuda extends StatefulWidget {
  final transferencia_de_Datos datos;
  const Ver_Cliente_Deuda(this.datos, {Key? key}) : super(key: key);

  Ver_Cliente_Deuda_App createState() => Ver_Cliente_Deuda_App();
}

class Ver_Cliente_Deuda_App extends State<Ver_Cliente_Deuda> {
  ...
  BuscarDocCliente(String IdCliente) async {
    ...
    try {
      ...
      if (base.docs.length != 0) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => Ver_Cliente_Deuda(widget.datos)));
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Deuda '+widget.datos.Deudas_NombreCliente),
      ),
      body: Column(
        children: [
          Resumen,
